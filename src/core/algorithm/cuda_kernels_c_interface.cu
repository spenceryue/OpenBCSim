...
void launch_DemodulateKernel (int grid_size, int block_size, cudaStream_t stream, cuComplex *signal, float w, int num_samples, int radial_decimation)
{
  DemodulateKernel<<<grid_size, block_size, 0, stream>>> (signal, w, num_samples, radial_decimation);
}
...
template void DLL_PUBLIC launch_FixedAlgKernel<false, false, false, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, false, false, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, false, true, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, false, true, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, true, false, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, true, false, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, true, true, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<false, true, true, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, false, false, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, false, false, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, false, true, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, false, true, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, true, false, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, true, false, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, true, true, false> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
template void DLL_PUBLIC launch_FixedAlgKernel<true, true, true, true> (int grid_size, int block_size, cudaStream_t stream, FixedAlgKernelParams params);
